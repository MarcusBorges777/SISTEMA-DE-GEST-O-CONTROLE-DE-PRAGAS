                 ...
                 <div className="space-y-4">
                     ...
                     <div className="grid grid-cols-2 gap-4">
                         <div>
                             ...
                             <input type="text" value={quoteNumber} onChange={(e) => setQuoteNumber(e.target.value)} className="w-full p-2.5 bg-gray-200/60 border border-gray-300/50 rounded-md text-sm font-semibold text-gray-800 focus:bg-white focus:border-[#324577]/40 focus:ring-2 focus:ring-[#324577]/10 outline-none transition-all" />
                         </div>
                         <div>
              ...
              <div className="border-l border-blue-200 pl-4 space-y-2 print:border-blue-200">
                ...
                <div className="pt-1 border-t border-blue-200 print:border-blue-200">
                    <div className="flex items-center gap-1">
                      ...
                      <input type="text" value={clientData.endereco} onChange={(e) => handleClientChange('endereco', e.target.value)} className="w-full bg-transparent border-b border-blue-100 p-0 text-[10px] focus:ring-0" placeholder="..." />
                    </div>
                </div>
              </div>
