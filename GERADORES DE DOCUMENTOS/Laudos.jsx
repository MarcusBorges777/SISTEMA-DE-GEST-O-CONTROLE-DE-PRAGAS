...
import { Mail, Phone, Globe, Shield, Droplets, Bug, ClipboardCheck, Calendar, Info, CheckCircle2, Upload, AlertTriangle, Edit3, ChevronDown, ChevronUp, X, Plus, Trash2, FileText } from 'lucide-react';
...
const App = () => {
  ...
  // Novos estados para o Alvará Sanitário
            ...
            <div className="bg-blue-50/50 p-4 rounded-lg border border-blue-100">
                ...
                <div className="flex flex-col md:flex-row gap-3">
                    ...
                    >
                        ...
                        Certificado de Higienização (Caixa D'água)
  ...
  return (
    <div className="min-h-screen bg-zinc-200 py-10 no-print flex flex-col items-center gap-4">
      ...
      <div className="fixed bottom-6 right-6 z-50 no-print">
        <button 
          onClick={handlePrint}
          disabled={!showPestControl && !showWaterTank}
      ...
      {/* PÁGINA 3: ALVARÁ SANITÁRIO (ANEXO OPCIONAL) */}
