...
import { Mail, Phone, Globe, Shield, Droplets, Bug, ClipboardCheck, Calendar, Info, CheckCircle2, Upload, AlertTriangle, X, Plus, Minus, Trash2, Archive, Save } from 'lucide-react';
...
import { LaudoEditorPanel } from '../../components/documentos/LaudoEditorPanel';
...
export default function Laudos() {
  ...
  const renderClientSection = (className = "") => (
    <section className={`bg-blue-50/30 p-3 rounded-lg border border-blue-100 w-full shadow-sm ${className}`}>
      <h3 className="flex items-center gap-2 text-[#254191] font-bold uppercase text-[9px] mb-2 border-b border-blue-200 pb-1 italic">
        <Shield size={12} /><span style={{display:'inline-block',transform:'translateY(-1px)'}}>Cliente / Contratante</span>
      </h3>
  ...
  return (
    <div id="a4-document" className="bg-zinc-200 py-10 print:py-0 print:bg-white flex flex-col print:block items-center gap-4 print:gap-0">
      ...
      <LaudoEditorPanel
        doc={{ showEditor, setShowEditor, showPestControl, setShowPestControl, showWaterTank, setShowWaterTank, showGreaseTrap, setShowGreaseTrap }}
        form={{ formData, handleInputChange, setFormData }}
        pest={{ pestOptions, togglePest }}
        cliente={{ clientesSalvos, setPickerOpen, handleSalvarCliente, cnpjValue, handleCnpjChange, isLoadingCnpj, cnpjStatus }}
          ...
          <section className="mb-4">
            <div className="flex justify-between items-end mb-2 border-b-2 border-blue-600 pb-1">
              <div className="flex items-center gap-2 text-[#254191] font-bold uppercase text-[10px]">
                <Bug size={14} /><span style={{display:'inline-block',transform:'translateY(-1px)'}}>Detalhamento do Controle de Vetores e Pragas</span>
              </div>
              <div className="flex gap-4 text-[9px] font-bold text-gray-700 pb-0.5">
                 <div className="flex items-center gap-1">
                   ...
                   <span className="uppercase" style={{display:'inline-block',transform:'translateY(-1px)'}}>Controle Químico</span>
                 </div>
                 <div className="flex items-center gap-1">
                   ...
                   <span className="uppercase" style={{display:'inline-block',transform:'translateY(-1px)'}}>Controle Não Químico</span>
                 </div>
              </div>
            </div>
        ...
        <div className={`a4-page relative bg-white shadow-2xl p-[15mm] flex flex-col print:shadow-none print:m-0 overflow-hidden ${showPestControl ? 'print:page-break' : ''}`}>
          ...
          <section className="mb-4 bg-blue-50/30 p-4 rounded-lg border border-blue-100 shadow-sm">
            <p className="font-bold text-[#254191] uppercase text-[9px] mb-2 flex items-center gap-2 italic border-b border-blue-200 pb-1">
              <Droplets size={12} /><span style={{display:'inline-block',transform:'translateY(-1px)'}}>Especificações do Serviço</span>
            </p>
          ...
          <section className="mb-4 overflow-hidden">
            <div className="flex items-center gap-2 text-[#254191] font-bold uppercase text-[10px] mb-2 border-b border-blue-200 pb-1 italic">
              <ClipboardCheck size={14} /><span style={{display:'inline-block',transform:'translateY(-1px)'}}>Protocolo Técnico Operacional Realizado</span>
            </div>
      ...
      {showGreaseTrap && (
        <div className={`a4-page relative bg-white shadow-2xl p-[15mm] flex flex-col print:shadow-none print:m-0 overflow-hidden ${(showPestControl || showWaterTank) ? 'print:page-break' : ''}`}>
          ...
          <section className="mb-4 bg-blue-50/30 p-4 rounded-lg border border-blue-100 shadow-sm">
            <p className="font-bold text-[#254191] uppercase text-[9px] mb-2 flex items-center gap-2 italic border-b border-blue-200 pb-1">
              <Archive size={12} /><span style={{display:'inline-block',transform:'translateY(-1px)'}}>Especificações do Serviço</span>
            </p>
