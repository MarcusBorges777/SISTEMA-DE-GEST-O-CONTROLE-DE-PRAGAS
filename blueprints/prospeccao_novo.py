...
para empresas de dedetização e controle de pragas
...
CNAES_OURO = {
    ...
    'saude': {
        'titulo': '🏥 Saúde',
        'descricao': 'Clínicas, Consultórios, Farmácias',
        'cnaes': [
            '8630-5/01',  # Atividade médica ambulatorial com recursos
            '8630-5/02',  # Atividade médica ambulatorial sem recursos
            '8630-5/03',  # Atividade odontológica
            '8630-5/04',  # Serviços de complementação diagnóstica
            '8630-5/99',  # Atividades de atenção ambulatorial
            '4771-7/01',  # Comércio varejista de produtos farmacêuticos
            '4771-7/02',  # Comércio varejista de artigos médicos
            '8640-2/02',  # Laboratórios de anatomia patológica
            '8640-2/03',  # Serviços de diálise e nefrologia
    ...
    'condominios': {
        'titulo': '🏢 Condomínios',
        'descricao': 'Síndicos e Administradoras',
        'cnaes': [
            '8112-5/00',  # Condomínios prediais
            '6822-6/00',  # Gestão e administração da propriedade imobiliária
            '8130-3/00',  # Atividades paisagísticas
            '6821-8/01',  # Corretagem na compra e venda
            '6821-8/02',  # Corretagem no aluguel de imóveis
        ],
        'ticket_medio': 'R$ 1.500-5.000/mês',
        'tipo_contrato': 'Mensal ou Anual',
    ...
    'estetica': {
        'titulo': '💅 Estética e Beleza',
        'descricao': 'Salões, Clínicas de Estética, SPAs',
        'cnaes': [
            '9602-5/01',  # Cabeleireiros, manicure e pedicure
            '9602-5/02',  # Atividades de estética e outros serviços
    ...
    'veterinaria': {
        'titulo': '🐾 Veterinária',
        'descricao': 'Clínicas Veterinárias, Pet Shops',
        'cnaes': [
            '7500-1/00',  # Atividades veterinárias
            '4789-0/05',  # Comércio varejista de produtos saneantes
            '4789-0/08',  # Comércio varejista de artigos do vestuário
        ],
        'ticket_medio': 'R$ 600-2.000/mês',
        'tipo_contrato': 'Mensal',
        'prioridade': 2
    ...
    'educacao': {
        'titulo': '📚 Educação',
        'descricao': 'Escolas, Creches, Berçários',
        'cnaes': [
            '8511-2/00',  # Educação infantil - creche
            '8512-1/00',  # Educação infantil - pré-escola
            '8513-9/00',  # Ensino fundamental
...
def buscar_empresas_segmento(segmento_id: str):
    """Busca empresas de um segmento específico"""
    ...
    # Filtro de bairro
    if bairro:
        query += f" AND LOWER(e.bairro) LIKE LOWER('%{bairro}%')"
    ...
    query += f" ORDER BY e.data_inicio_atividades DESC LIMIT {limite} OFFSET {offset}"
